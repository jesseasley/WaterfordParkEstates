<script src="images/borders/shadowFrame/shadowFrame.js"></script>
<?php
$path = "blockparty200910";
?>
...
//	   echo "<a title=\"Click here to enlarge\" imagetitle=\"" . $file . "\" href=\"pages/" . $path . "/" . $file . "\" rel=\"lightbox\">\n<img src='pages/" . $path . "/" . $file . "' width=300 height=199></a>\n";
