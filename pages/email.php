...
include "../includes/functions.php";
	...
	SendSingleEmail($_POST["boardEmail"], valueOf("post", "subjectText"), $body);
	...
	$body .= "		<br><br>";
	$body .= "		Please click <a href=\"#\" onclick=\"pageChange('home.php');\">here</a> to return to the main page.</b>";
	$body .= "	</td>";
	$body .= "</tr>";
	$body .= "</table>";
	echo $body;
